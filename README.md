...
- "Course" class: represents a course part of a department and manages registered students, course assignments, student scores and the display of academic records containing the aforementioned elements.
