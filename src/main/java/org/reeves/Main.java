...
public class Main {
    public static void main(String[] args) {
        ...
        Address address1 = new Address(5555, "Av. Patrice Lumumba", "Night City" ,Address.Province.ON, "W4H4L4");
        Address address2 = new Address(5556, "Av. Songbird", "Dogtown" ,Address.Province.NS, "W7H7L7");
        Student student1 = new Student("Aubrey Graham", Student.Gender.MALE, address1, department);
        Student student2 = new Student("Aubrey Graham", Student.Gender.MALE, address1, department);
